...
*   **Data.** We use third party tools, Google Analytics and FullStory, Inc. (FullStory), to measure MoQuality.com’s audience and usage. You agree to MoQuality storing and analyzing your usage data and the data transferred by the application under test. By upload your application on MoQuality.com and using the service, you agree to assign the data relating to your application's user interface, network traffic and the usage of the application to MoQuality and authorize us to analyze it for testing and training purposes. 
