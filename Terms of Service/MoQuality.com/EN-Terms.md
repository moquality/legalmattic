...
The following terms and conditions ("Terms") govern all use of the MoQuality.com website and all content, services, and products available at or through the website, including, but not limited to, App.MoQuality.com ("App"), Barista App for Android ("Barista"), and MoQuality Recorder App ("MQRecorder"), (taken together, our "Services"). Our Services are offered subject to your acceptance without modification of all of the terms and conditions contained herein and all other operating rules, policies (including, without limitation, [MoQuality's Privacy Policy](http://moquality.com/privacy/)) and procedures that may be published from time to time by MoQuality (collectively, the "Agreement"). You agree that we may automatically upgrade our Services, and these Terms will apply to any upgrades. Your agreement is with MoQuality Inc, registered in the state of Georgia in the US. 
...
*   **Analytics.** We use third party tools, Google Analytics and FullStory, Inc. (FullStory), to measure MoQuality.com’s audience and usage. You agree to MoQuality storing and analyzing your analytics and behavior data to improve its services. 
*   **Test Data.**: While testing the application under test, MoQuality might capture and store information about your application and use it for Machine Learning and training purposes. By upload your application on MoQuality.com and using the service, you agree to assign the test data relating to your application's user interface, network traffic and usage logs/recordings of the application to MoQuality and authorize us to leverage it for the purposes of testing and Machine Learning, to improve MoQuality's services. 
*   **Attribution.** MoQuality reserves the right to display attribution text or links in the test reports generated, attributing MoQuality.com for generating the report for example. The attribution may not be altered or removed. Attribution text or links may only be hidden if you are subscribed to MoQuality.com as an enterprise customer, and if the contract has verbiage to remove attribution.
*   **Payment and Renewal.**
    *   **General Terms.** Paid services such as test execution, integrations or reporting are available (any such services, an "Plan"). By subscribing to a Plan you agree to pay MoQuality the monthly or annual subscription fees, along with any usage fee associated for the service as indicated. Subscription payments will be charged on a pre-pay basis on the day you sign up for an Plan and will cover the use of that service for a monthly or annual subscription period as indicated, and the usage fee for the prior month or annual term, if not already included in the subscription costs.
    *   **Automatic Renewal.** Unless you notify MoQuality before the end of the applicable subscription period that you want to cancel a Plan, your Plan subscription will automatically renew and you authorize us to collect the then-applicable annual or monthly subscription fee and the usage fees for such Plan (as well as any taxes) using any credit card or other payment mechanism we have on record for you. Plans can be canceled at any time in the Accounts section of the MoQuality dashboard.

#### 2. Copyright Infringement and DMCA Policy.

As MoQuality asks others to respect its intellectual property rights, it respects the intellectual property rights of others. If you believe that materials uploaded by another user on MoQuality.com violates your copyright, you are encouraged to notify MoQuality. MoQuality will respond to all such notices, including as required or appropriate by removing the infringing material. MoQuality will terminate a uploader's access to and use of the app on its website if, under appropriate circumstances, the uploader is determined to be a repeat infringer of the copyrights or other intellectual property rights of MoQuality or others. In the case of such termination, MoQuality will have no obligation to provide a refund of any amounts previously paid to MoQuality.
...
**Except to the extent applicable law, if any, provides otherwise, this Agreement, any access to or use of our Services will be governed by the laws of the state of Georgia, U.S.A., excluding its conflict of law provisions, and the proper venue for any disputes arising out of or relating to any of the same will be the state and federal courts located in Atlanta, GA.**
